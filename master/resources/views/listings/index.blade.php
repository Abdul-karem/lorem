...
<section id="contents" class="project-area solid-bg">     
  ...
  <div class="container mt-4">
    <div class="row">
        ...
        <div class="col-lg-6">
          <div class="card mb-4">
            <div class="card-body">
              ...
              <img src="{{ asset('imagess/' . $listing->logo) }}" alt="clasec" class="img-fluid" style="height: 300px; width: 100%;">

              @else
            <a href="{{ route('listings.show', ['listing' => $listing->id]) }}"><img src="https://i.pinimg.com/564x/f4/0d/4d/f40d4dd18bacf2bcfc2d2fa0389b9605.jpg" alt="test" style="height: 300px ; width:100% " ></a>  
              @endif
            </div>
          </div>
        </div>
      ...
      @if(count($listings) === 0)
        <div class="col-md-12">
          <p class="alert alert-info"   >No listings found</p>
        </div>
      @endif
    </div>
  ...
  <section class="content"  id="project-area"  >  
    <div class="container">
      <div class="row">
          <div class="col-lg-6">
  ...
  <section class="subscribe no-padding" id="contact"   >    
    <div class="container">
      <div class="row">
          <div class="col-lg-4">
